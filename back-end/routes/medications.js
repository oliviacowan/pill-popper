...
module.exports = (db) => {
  ...
  router.post('/:childId/new', (req, res) => {
    ...
    const { dose, name, with_food, text_message, start_date, end_date, fda_id, times} = req.body;
    console.log('bod: ', req.body);
    db.query(
      `INSERT INTO childrens_medications 
      (child_id, name, dose, with_food, text_message, end_date, fda_id)
      Values ($1, $2, $3, $4, $5, $6, $7)
      RETURNING id;`, [childId, name, dose, with_food, text_message, end_date, fda_id]
      ).then((response)=> {
